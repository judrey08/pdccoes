...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["password"]))){
        $password_err = "<I style='color:red;'>Please enter your password.</I>";
    } else{
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
           <!-- ~~~~~~~~~~~~~~~~~~~~ username ~~~~~~~~~~~~~~~~~~~~ -->
            ...
            <div class="form-group">
                <input type="submit" class="btn btn-primary col-sm-4" value="Login">
                <p>Don't have an account? <a href="register.php">Sign up now</a>.<BR>Forgot Password? <a href="search-reset.php">Reset Password</a>.</p>
            </div>
        </form>
    </div>  
</center>
